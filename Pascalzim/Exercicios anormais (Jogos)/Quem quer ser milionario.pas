...
begin
  ...
  case pergunta_aleatoria of
    0: begin
      ...
      write('c) Barcelona'); write('d) Porto':15);  writeln;
      readln(Resposta);
    ...
    1: begin
      ...
      write('c) 1968'); write('d) 1990':15);  writeln;  
      readln(Resposta);
    ...
    2: begin
      ...
      write('c) José Saramago'); write('d) Sophia de Mello Breyner':30);writeln;
      readln(Resposta);  
      if (Resposta = 'b') or (Resposta = 'B') then
      begin
        clrscr; writeln('Acertou'); ponto := ponto + 1000;
    ...
    3: begin
      ...
      write('c) Feijoada'); write('d) Bacalhau à Brás':25);writeln;
      readln(Resposta);    
    ...
    4: begin
      ...
      write('c) Tejo'); write('d) Sena':15); writeln;
      readln(Resposta); 
    ...
    5: begin
      ...
      write('c) Vasco da Gama'); write('d) Fernão Magalhães':25); writeln;{ Correção histórica: Magalhães/Elcano }
      readln(Resposta); 
      if (Resposta = 'd') or (Resposta = 'D') then
      begin
        clrscr; writeln('Acertou'); ponto := ponto + 1000;
    ...
    6: begin
      ...
      write('c) Faro'); write('d) Coimbra':15);  writeln;
      readln(Resposta);                        
      if (Resposta = 'b') or (Resposta = 'B') then
      begin
        clrscr; writeln('Acertou'); ponto := ponto + 1000;
    ...
    7: begin
      ...
      write('c) Porto Santo'); write('d) Terceira':15);writeln;
      readln(Resposta);       
      if (Resposta = 'b') or (Resposta = 'B') then
      begin
        clrscr; writeln('Acertou'); ponto := ponto + 1000;
    ...
    8: begin
      ...
      write('c) Luis Figo'); write('d) Eusébio':25);writeln;
      readln(Resposta);      
      if (Resposta = 'a') or (Resposta = 'A') then
      begin
        clrscr; writeln('Acertou'); ponto := ponto + 1000;
    ...
    10: begin
      ...
      write('c) Porto'); write('d) Lisboa':15);writeln;
      readln(Resposta); 
      if (Resposta = 'b') or (Resposta = 'B') then
      begin
        clrscr; writeln('Acertou'); ponto := ponto + 1000;
    ...
    11: begin
      ...
      write('c) 1973'); write('d) 2001':15); writeln;
      readln(Resposta);
      if (Resposta = 'a') or (Resposta = 'A') then
      begin
        clrscr; writeln('Acertou'); ponto := ponto + 1000;
    ...
    12: begin
      ...
      write('c) António Lobo Antunes'); write('d) Egas Moniz':20); writeln;
      readln(Resposta);
      if (Resposta = 'a') or (Resposta = 'A') then
      begin
        clrscr; writeln('Acertou'); ponto := ponto + 1000;
    ...
    13: begin
      ...
      write('c) Cabo Horn'); write('d) Cabo de São Vicente':25);  writeln;
      readln(Resposta);
      if (Resposta = 'b') or (Resposta = 'B') then
      begin
        clrscr; writeln('Acertou'); ponto := ponto + 1000;
    ...
    14: begin
      ...
      write('c) Cabo Verde'); write('d) São Tomé e Príncipe':25);  writeln;
      readln(Resposta);
      if (Resposta = 'a') or (Resposta = 'A') then
      begin
        clrscr; writeln('Acertou'); ponto := ponto + 1000;
    ...
    15: begin
      ...
      write('c) Fernão Mendes Pinto'); write('d) Vasco da Gama':25); writeln;
      readln(Resposta);
      if (Resposta = 'd') or (Resposta = 'D') then
      begin
        clrscr; writeln('Acertou'); ponto := ponto + 1000;
    ...
    16: begin
      ...
      write('c) Coimbra'); write('d) Viana do Castelo':25); writeln;
      readln(Resposta);
      if (Resposta = 'a') or (Resposta = 'A') then
      begin
        clrscr; writeln('Acertou'); ponto := ponto + 1000;
    ...
    17: begin
      ...
      write('c) Ponte do Infante'); write('d) Ponte D. Luís':20); writeln;
      readln(Resposta);
      if (Resposta = 'b') or (Resposta = 'B') then
      begin
        clrscr; writeln('Acertou'); ponto := ponto + 1000;
    ...
    18: begin
      ...
      write('c) Manuel de Arriaga'); write('d) Teófilo Braga':20); writeln;
      readln(Resposta);
      if (Resposta = 'c') or (Resposta = 'C') then
      begin
        clrscr; writeln('Acertou'); ponto := ponto + 1000;
    ...
    19: begin
      ...
      write('c) Bairrada'); write('d) Dão':15); writeln;
      readln(Resposta);
      if (Resposta = 'b') or (Resposta = 'B') then
      begin
        clrscr; writeln('Acertou'); ponto := ponto + 1000;
